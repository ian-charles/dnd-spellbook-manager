    ...
    steps: [
      {
        ...
        title: 'Search Spells',
        description: 'Type a spell name to quickly find it. Try it now! Search for "Fireball" or "Cure Wounds".',
        placement: 'bottom',
        interactive: true,
      },
      {
      ...
      },
      {
        ...
        title: 'Spell List',
        description: 'Browse all D&D spells here. Use the sort buttons above to organize them.',
      ...
      },
      {
        ...
        description: 'Tap any spell to see its full description. Try it now!',
        desktopDescription: 'Click any spell to see its full description. Try it now!',
        placement: 'bottom',
        interactive: true,
      },
      {
        ...
        title: 'Select Spells',
        description: 'Select and deselect spells by long-pressing or swiping to the side. Give it a shot!',
        desktopDescription: 'Check the box to select spells. Try it now! You can select multiple spells at once.',
        placement: 'bottom',
